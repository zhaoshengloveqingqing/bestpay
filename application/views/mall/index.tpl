				...
				{row}
					{ul class="nav nav-pills nav-title"}
						{li role="presentation" class="nav-classify__title"}
							...
							{/div}
						{/li}
						{li role="presentation" id="amount"}
							{action}{lang}销量{/lang}{/action}
						{/li}
						{li role="presentation" id="price"}
							{action}{lang}价格{/lang}{/action}
						{/li}
						{li role="presentation" id="time"}
							{action}{lang}时间{/lang}{/action}
						{/li}
					{/ul}
				{/row}
				{row class="list"}
					{listview id="mall_index" name='mall_index'}
